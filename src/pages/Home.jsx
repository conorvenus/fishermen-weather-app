...
<stop offset="1" stop-color="#5193DE"/>
                ...
                <h1 className="font-bold text-7xl">10&deg;</h1>
                <p className="text-light-gray">Sunny in Mile End, United Kingdom</p>
            </section>
            <div className="bg-dark-gray border border-gray rounded-2xl w-full min-h-[150px] shadow-primary grid grid-cols-3 text-center items-center">
                <div className="h-[60%] w-full flex items-center flex-col justify-center border border-l-0 border-y-0 border-r-light-gray/20">
                    <h1 className="font-bold">17 km/h</h1>
            ...
            <section className="grid grid-cols-3 w-full gap-4">
                <div className="bg-dark-gray border border-gray rounded-2xl p-4 h-[150px] shadow-primary"></div>
                <div className="bg-dark-gray border border-gray rounded-2xl p-4 shadow-primary"></div>
                <div className="bg-dark-gray border border-gray rounded-2xl p-4 shadow-primary"></div>
            </section>
            <div className="bg-dark-gray border border-gray rounded-2xl w-full min-h-[150px] shadow-primary grid grid-cols-3 text-center items-center">
                <div className="h-[60%] w-full flex items-center flex-col justify-center border border-l-0 border-y-0 border-r-light-gray/20">
                    <h1 className="font-bold">13 km/h</h1>
                    <p className="text-light-gray">Wind</p>
                </div>
                <div className="h-[60%] w-full flex items-center flex-col justify-center border border-l-0 border-y-0 border-r-light-gray/20">
                    <h1 className="font-bold">56%</h1>
